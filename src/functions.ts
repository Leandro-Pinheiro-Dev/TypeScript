...
/*
 * A interface abaixo define que:
 *
 * - A função deve receber dois números
 * - Deve retornar uma string ou um número
 */
...
// ======================================================
// INTERFACE COM MAIS PARÂMETROS
// ======================================================

/*
 * Interfaces podem definir qualquer quantidade
 * de parâmetros.
 */
...
const calculator: CompleteOperation = (
  firstValue,
  secondValue,
  operation
): string => {
...
/*
 * O símbolo ? torna um parâmetro opcional.
 */
...
/*
 * Também poderíamos criar a mesma assinatura
 * usando Type Alias.
 */
